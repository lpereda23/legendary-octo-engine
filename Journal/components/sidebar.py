    ...
    return rx.link(
        rx.hstack(
            rx.match(
                ...
                ("Journal", sidebar_item_icon("notebook-text")),
...
def sidebar() -> rx.Component:
    ...
    # Only include pages needed, excluding Login and Register
    ordered_pages = [page for page in pages if page['route'] in ["/", "/notebook", "/profile", "/settings"] ]
